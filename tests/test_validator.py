"""This module exists to test the validator on a minimal valid product. 
It guards against regressions in required field handling. 
Possible improvement: add tests for duplicates and missing field flags."""
