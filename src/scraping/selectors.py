"""This module exists to centralize CSS selectors used by the scraper. 
It keeps selector changes localized and easy to update. 
Possible improvement: make selectors site configurable instead of hard coded."""
